                      ...
                      <td className="p-4 text-right">
                        <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button 
                            ...
                            className="px-3 py-1 text-xs font-bold  hover:   transition-colors"
                          >
                            <Edit size={16}/>
                          </button>
                          <button 
                            ...
                            className="px-3 py-1 text-xs font-bold  hover:   disabled:opacity-0 transition-colors"
                          >
                            <Trash2 size={16}/>
                          </button>
                        </div>
...
fs.writeFileSync('./src/pages/admin-portal/UserManagement.jsx', content, 'utf8');
